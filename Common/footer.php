    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12 segment-one md-mb-30 sm-mb-30">
          ...
          <p>This Project has been made by Nisha Aya with the help of
            my Mentor.
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 segment-two md-mb-30 sm-mb-30">
          ...
          <p>Address: Imperial College of Business Studies,Maninagar
            Ahmedabad,Gujarat – India</p>
          <p>Contact : (+91) 9874563210</p>
          <p>E-mail: imperialclg@gmail.com</p>
        </div>
      </div>
    </div>
  </div>
  <p class="footer-bottom-text">CopyRights © reserved by Nisha Programming and Code Academia.2020</p>
</footer>
</body>
